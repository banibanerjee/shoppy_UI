        ...
        <section className="max_padd-container pt-28">
            <table className="w-full mx-auto">
                ...
                <tbody>
                    {all_products.map((e) => {
                        if (cartItems[e.id] > 0) {
                            return <tr key={e.id} className="border-b border-slate-900/20 text-gray-20 p-6 medium-14 text-center">
                                <td className="flexCenter"><img src={e.image} alt="prodctImg" height={43} width={43} className="rounded-lg ring-1 ring-slate-900/5 my-1" /></td>
